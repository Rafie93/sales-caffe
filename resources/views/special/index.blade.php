            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-left">
                        <li class="active">Data Produk Special</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        <div class="row">
                                            <div class="form-group col-lg-8" style="float: left">
                                                <a href="{{Route('product.special.create')}}" class="btn btn-lg btn-info"> <i class="ace-icon fa fa-plus bigger-110"></i>
                                                    Add New Data</a>
                                            </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Produk</th>
                                <th class="d-none d-xl-table-cell">Provinsi</th>
                                <th class="d-none d-xl-table-cell">Kota</th>
                                <th>Status</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
        ...
        $().ready( function () {
            $(".delete").click(function() {
                ...
                swal({
                    ...
                    text: "Yakin ingin menghapus data produk special / khas  : "+name+" ini ?" ,
                    type: "warning",
                ...
                function(){
                    setTimeout(function(){
                         window.location =  "/special/"+id+"/delete";
                    }, 2000);
                });
            });
        } );
