    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6 col-xxl-6 d-flex">
            <div class="card flex-fill">
                <form action="{{Route('stores.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
							...
							<div class="card">
								<div class="card-body">
                                    ...
                                    <div class="form-group @error('code') has-error @enderror">
									    ...
									    <input type="text" class="form-control @error('code') is-invalid @enderror" placeholder="" name="code" value="{{old('code')?old('code'):$data->code}}">
                                         @error('code')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                     ...
                                     <div class="form-group @error('phone') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" placeholder="" name="phone" value="{{old('phone')?old('phone'):$data->phone}}">
                                         @error('phone')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group @error('email') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="" name="email" value="{{old('email')?old('email'):$data->email}}">
                                         @error('email')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group @error('address') has-error @enderror">
                                        ...
                                        <textarea name="address" class="form-control @error('address') is-invalid @enderror">{{old('address')?old('address'):$data->address}}</textarea>
                                        @error('address')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group @error('latitude') has-error @enderror">
                                        ...
                                        <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror"
                                         placeholder="0.00" name="latitude" value="{{old('latitude')?old('latitude'):$data->latitude}}" >
                                         @error('latitude')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                     ...
                                     <div class="form-group @error('longitude') has-error @enderror">
                                        ...
                                        placeholder="0.00" name="longitude" value="{{old('longitude')?old('longitude'):$data->longitude}}" >
                                         @error('Longitude')
                                                <span class="help-block" role="alert">
