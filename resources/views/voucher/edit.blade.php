                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group @error('type') has-error @enderror">
                                        ...
                                        <select name="type" class="form-control">
                                            <option value="Diskon" {{$data->type=='Diskon' ? 'selected' : ''}}>Diskon</option>
                                    ...
                                    <div class="form-group @error('maximum_amount') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control"
                                        placeholder="kosongkan tanpa maksimal" name="maximum_amount" value="{{old('maximum_amount') ? old('maximum_amount') :  $data->maximum_amount}}">
