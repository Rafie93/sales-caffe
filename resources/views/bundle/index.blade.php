            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-left">
                        <li class="active">Data Product Bundle</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        <div class="row">
                                            <div class="form-group col-lg-8" style="float: left">
                                                <a href="{{Route('product.bundle.create')}}" class="btn btn-lg btn-info"> <i class="ace-icon fa fa-plus bigger-110"></i>
                                                    Add New Bundle</a>
                                            </div>
        ...
        $().ready( function () {
            $(".delete").click(function() {
                ...
                swal({
                    ...
                    text: "Yakin ingin menghapus data bundle  : "+name+" ini ?" ,
                    type: "warning",
                ...
                function(){
                    setTimeout(function(){
                         window.location =  "/bundle/"+id+"/delete";
                    }, 2000);
                });
            });
        } );
