            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-left">
                        ...
                        <li class="active">Tambah Produk Bundle</li>
                    </ol>
                </div>
            </div>
        </div>   
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group @error('cost_of_goods') has-error @enderror">
                                        ...
                                        name="cost_of_goods" value="{{old('cost_of_goods') ? old('cost_of_goods') : 0}}" >
                                        @error('cost_of_goods')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group @error('price_sales') has-error @enderror">
                                        ...
                                        name="price_sales" value="{{old('price_sales') ? old('price_sales') : 0}}" >
                                        @error('price_sales')
                                                <span class="help-block" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
