                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group @error('cost_of_goods') has-error @enderror">
                                        ...
                                        <input type="number" required class="form-control @error('cost_of_goods') has-error @enderror"
                                    ...
                                    <div class="form-group @error('weight') has-error @enderror">
                                     ...
                                     <div class="form-group @error('is_stock') has-error @enderror">
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="is_stock" @if ($data->is_stock==1)
                                                    checked
                                                @endif  value="1">
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="is_stock" @if ($data->is_stock==0)
                                                    checked
                                                @endif  value="0">
                                                <span class="form-check-label">
                                                Tidak
                                    ...
                                    <div class="form-group @error('long_delivery') has-error @enderror">
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="long_delivery" @if ($data->long_delivery==1)
                                                    checked
                                                @endif   value="1">
                                                <span class="form-check-label">
                                                Ya
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="long_delivery" @if ($data->long_delivery==0)
                                                    checked
                                                @endif  value="0">
                                                <span class="form-check-label">
                                                Tidak
                                    ...
                                    <div class="form-group @error('status') has-error @enderror">
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="status" @if ($data->status==0)
                                                    checked
                                                @endif  value="0">
                                                <span class="form-check-label">
                                                Tidak Aktif
                                    ...
                                    <div class="form-group @error('is_show_menu') has-error @enderror">
                                        ...
                                        <label class="form-check form-check-inline col-md-4">
                                            <input class="form-check-input" type="radio" name="is_show_menu" @if ($data->is_show_menu==1)
                                                    checked
                                                @endif  value="1">
                                            <span class="form-check-label">
                                            Ya
                                        ...
                                        <label class="form-check form-check-inline col-md-4">
                                            <input class="form-check-input" type="radio" name="is_show_menu" @if ($data->is_show_menu==0)
                                                    checked
                                                @endif  value="0">
                                            <span class="form-check-label">
                                            Tidak
                                    ...
                                    <div class="form-group @error('is_ppn') has-error @enderror">
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="is_ppn" @if ($data->is_ppn==1)
                                                    checked
                                                @endif  value="1">
                                                <span class="form-check-label">
                                                Ya
                                            ...
                                            <label class="form-check form-check-inline col-md-4">
                                                <input class="form-check-input" type="radio" name="is_ppn" @if ($data->is_ppn==0)
                                                    checked
                                                @endif  value="0">
                                                <span class="form-check-label">
                                                Tidak
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group @error('description') has-error @enderror">
                                        ...
                                        <textarea name="description" id="editor" class="form-control @error('description') has-error @enderror">
