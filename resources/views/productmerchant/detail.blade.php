                ...
                <div class="card alert">
                    <div class="card-body">
                         <div class="form-group" style="float: right">
                            <a href="#" class="btn btn-lg btn-info"> <i class="glyphicon glyphicon-edit"></i>
                                Edit Data</a>
                        </div>
                        <br/>
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="1">
                                                <div class="contact-information">
                                                    ...
                                                    <div class="phone-content">
                                                        <span class="contact-title">Deskripsi </span>
                                                        <span class="phone-number">{{$data->description}}</span>
                                                    </div>
                                                </div>
